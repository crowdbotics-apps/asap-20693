...
admin.site.site_header = "ASAP"
admin.site.site_title = "ASAP Admin Portal"
admin.site.index_title = "ASAP Admin"

# swagger
api_info = openapi.Info(
    title="ASAP API",
    default_version="v1",
    description="API documentation for ASAP App",
)
